...
export const CulturalHighlightsTeaser: React.FC<CulturalHighlightsTeaserProps> = ({ onNavigate }) => {
  ...
  return (
    <section id="cultural-teasers-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div
          ...
          className="bg-white border border-[#E8E1D7] rounded-xl overflow-hidden shadow-xs hover:shadow-lg transition-all duration-300 cursor-pointer group flex flex-col justify-between"
        >
          ...
          <div className="p-6 flex flex-col flex-grow justify-between">
            <div>
              ...
              <h3 className="font-heading font-bold text-xl text-[#182338] group-hover:text-[#D95D39] transition-colors leading-snug">
                {getLocalized(eventTeaser.title)}
              </h3>
            </div>
            <div className="mt-6 pt-3 border-t border-[#F0EAE1] flex items-center justify-between text-xs font-semibold text-[#182338] group-hover:text-[#D95D39]">
