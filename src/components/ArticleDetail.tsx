...
export const ArticleDetail: React.FC<ArticleDetailProps> = ({
  ...
  return (
    <article id={`article-page-${article.slug}`} className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      
      {/* Top Navigation Bar & Breadcrumb */}
      <div className="flex items-center justify-between mb-8 pb-4 border-b border-[#E5DFD5]">
        <button
          id="article-back-btn"
          onClick={onBack}
          className="inline-flex items-center gap-2 text-sm font-bold text-[#182338] hover:text-[#D95D39] transition-colors cursor-pointer group"
        >
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs uppercase tracking-wider font-semibold text-[#8E7E73] bg-[#EAE2D8] px-3 py-1 rounded-full">
      ...
      <header className="mb-10 text-center max-w-4xl mx-auto">
        <div className="flex flex-wrap items-center justify-center gap-4 text-xs font-semibold text-[#6F645A] mb-4">
          <span className="inline-flex items-center gap-1 text-[#D95D39]">
        ...
        {/* 
          ...
          Weights strictly 400-700 (never 800/900).
        */}
        <h1 className="font-heading font-bold text-3xl sm:text-4xl md:text-5xl lg:text-[3.25rem] text-[#182338] leading-[1.18] tracking-tight mb-6">
          {getLocalized(article.title)}
        </h1>

        {article.subtitle && (
          <p className="text-lg sm:text-xl text-[#55657E] font-normal leading-relaxed mb-8 max-w-3xl mx-auto">
            {getLocalized(article.subtitle)}
          </p>
        )}

        {/* Author Byline Box */}
        <div className="inline-flex items-center gap-3.5 bg-[#F4EFEA] border border-[#E8E1D7] px-5 py-2.5 rounded-full">
          <img
          ...
          <div className="text-start">
            ...
            <p className="text-[11px] text-[#8E7E73] font-medium">
