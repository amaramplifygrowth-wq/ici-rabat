      ...
      <div id="about-page" className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        <ScrollReveal direction="up" distance={20}>
          <div className="text-center mb-8 sm:mb-12">
            <span className="text-[11px] sm:text-xs uppercase tracking-[0.25em] font-bold text-[#D95D39]">
              {language === 'ar' ? 'البيان التحريري' : language === 'en' ? 'EDITORIAL MANIFESTO' : 'MANIFESTE ÉDITORIAL'}
            </span>
            <h1 className="font-heading font-bold text-2xl sm:text-5xl text-[#182338] mt-2 mb-3 sm:mb-4 leading-tight">
              {t.aboutTitle}
            </h1>
            <p className="text-sm sm:text-lg text-[#55657E] max-w-2xl mx-auto font-normal">
              {t.aboutDesc}
            </p>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal direction="up" distance={24} delay={0.1}>
          <div className="bg-white border border-[#E8E1D7] rounded-2xl p-6 sm:p-12 shadow-sm space-y-5 sm:space-y-6 text-[#334155] leading-relaxed text-sm sm:text-lg">
            ...
            <div className="my-6 sm:my-8 p-5 sm:p-6 bg-[#FAF8F5] border-s-4 border-[#234238] rounded-r-xl">
              <p className="font-heading font-semibold text-base sm:text-xl text-[#182338] italic">
                {language === 'ar'
            ...
            <div className="pt-5 sm:pt-6 border-t border-[#EBE4DA] flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs text-[#8E7E73]">
  ...
  return (
    <div id={`upcoming-page-${view}`} className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16">
      ...
      <div className="mb-6 sm:mb-8 flex items-center justify-between">
        ...
        <span className="text-[11px] sm:text-xs font-medium text-[#8E7E73] bg-[#EAE2D8]/60 px-3 py-1 rounded-full border border-[#DDD5C9]">
      ...
      <ScrollReveal direction="up" distance={20}>
        <div className="bg-white border border-[#E8E1D7] rounded-3xl p-6 sm:p-12 shadow-sm text-center mb-10 sm:mb-12 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            <div className="inline-flex items-center gap-2 px-3 py-1 text-[11px] sm:text-xs font-bold uppercase tracking-wider bg-[#FAF0EB] text-[#D95D39] border border-[#F4DDD2] rounded-full mb-3 sm:mb-4">
            ...
            <h1 className="font-heading font-bold text-2xl sm:text-5xl text-[#182338] leading-tight mb-3 sm:mb-4">
              {getLocalized(upcomingConfig.title)}
            </h1>

            <p className="text-sm sm:text-lg text-[#55657E] leading-relaxed mb-6 sm:mb-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 pt-2">
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 py-3.5 bg-[#D95D39] hover:bg-[#B84A28] text-white text-xs sm:text-sm font-bold rounded-xl shadow-xs transition-colors cursor-pointer"
              >
              ...
              <a
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-3.5 bg-[#FAF8F5] hover:bg-[#F2ECE3] text-[#182338] border border-[#DDD5C9] text-xs sm:text-sm font-bold rounded-xl transition-colors cursor-pointer"
              >
      ...
      <div className="mb-12 sm:mb-14">
        <div className="flex items-center justify-between mb-5 sm:mb-6 pb-2 border-b border-[#E8E1D7]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          {upcomingConfig.curatedTeasers.map((teaser, idx) => (
            <ScrollReveal key={idx} direction="up" distance={20} delay={idx * 0.08}>
              <div className="bg-white border border-[#E8E1D7] rounded-2xl overflow-hidden shadow-xs hover:shadow-md transition-shadow flex flex-col justify-between group h-full">
                ...
                <div className="p-5 sm:p-7 flex flex-col flex-grow justify-between">
                  <div>
                    ...
                    <h3 className="font-heading font-bold text-lg sm:text-2xl text-[#182338] leading-snug">
                      {getLocalized(teaser.title)}
                    </h3>
                  </div>

                  <div className="mt-5 sm:mt-6 pt-4 border-t border-[#F0EAE1] flex items-center justify-between text-xs text-[#8E7E73]">
      ...
      <ScrollReveal direction="up" distance={16}>
        <div className="mb-12 sm:mb-14 p-5 sm:p-8 bg-[#FAF8F5] border border-[#E0D8CD] rounded-2xl flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
          <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-[#234238] text-white flex-shrink-0 flex items-center justify-center shadow-xs">
            <Compass className="w-5 h-5 sm:w-6 sm:h-6" />
          </div>
          <div className="text-center sm:text-start flex-grow">
            <h4 className="font-heading font-bold text-base sm:text-lg text-[#182338] mb-1">
              {language === 'ar'
      ...
      <ScrollReveal direction="up" distance={20}>
        <div
          ...
          className="bg-white border-2 border-[#E5DFD5] rounded-3xl p-6 sm:p-10 text-center max-w-2xl mx-auto shadow-xs relative"
        >
          <div className="w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-[#FAF0EB] border border-[#F4DDD2] flex items-center justify-center text-[#D95D39] mx-auto mb-3 sm:mb-4">
            <Mail className="w-5 h-5 sm:w-6 sm:h-6" />
          </div>

          <h3 className="font-heading font-bold text-xl sm:text-3xl text-[#182338] mb-2">
            {isEvents
          ...
          <p className="text-xs sm:text-sm text-[#55657E] mb-5 sm:mb-6 max-w-md mx-auto leading-relaxed">
            {language === 'ar'
          ...
          {isSubmitted ? (
            <div className="flex items-center justify-center gap-2 text-xs sm:text-sm font-semibold text-[#234238] bg-[#E2ECE7] py-3 px-5 sm:py-3.5 sm:px-6 rounded-xl border border-[#C5DDD2]">
              <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#234238]" />
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2.5 max-w-md mx-auto">
              <input
                ...
                className="flex-grow px-4 py-3 sm:py-3.5 bg-[#FAF8F5] border border-[#DDD5C9] rounded-xl text-xs sm:text-sm focus:outline-hidden focus:border-[#182338] focus:bg-white text-[#182338]"
              />
              <button
                type="submit"
                className="px-5 py-3 sm:px-6 sm:py-3.5 bg-[#182338] hover:bg-[#D95D39] text-white text-xs sm:text-sm font-bold rounded-xl transition-colors cursor-pointer inline-flex items-center justify-center gap-2"
              >
          ...
          <div className="mt-4 flex items-center justify-center gap-2 text-[10px] sm:text-[11px] text-[#8E7E73]">
